<template>
  <h1>Settings</h1>
  <el-form :model="form" label-width="200" style="width: 2000">
    ...
    <el-select v-model="form.lorawan.server" placeholder="Please select your network operator">
        <el-option label="Helium" value="helium" />
        <el-option label="The Things Network" value="ttn" :disabled="true" />
    </el-select>
    </el-form-item>
    <el-form-item label="DevEUI">
    <el-input v-model="form.lorawan.deveui"/>
    </el-form-item>
    <el-form-item label="APPEUI">
    <el-input v-model="form.lorawan.appeui" />
    </el-form-item>
    <el-form-item label="APPKEY">
    <el-input v-model="form.lorawan.appkey" />
    </el-form-item>
    ...
    <el-popover :width="400">
        ...
        >
            ...
            might be useful for time-at-location tracking or other
            monitoring.
            </p>
    ...
    <el-popover :width="400">
        ...
        >
            <p class="demo-rich-content__desc" style="margin: 0">
            If we still haven't moved in this many seconds, start sending
            even slower
            </p>
        </div>
        </template>
    ...
    <el-popover :width="400">
        ...
        >
            ...
            <p>
            This is useful to avoid sending many redundant packets in your
            own driveway or office, or just for local privacy.
            </p>
            <p>
